...
func TestWorkHelloAdvertisesCapabilityAndReconcilesFromClientCursor(t *testing.T) {
	...
	if !ok || len(capabilities) != 5 || capabilities[4] != "message_queue_v1" || capabilities[0] != "work_coordination_v1" || capabilities[1] != "work_items_v1" || capabilities[2] != "project_bootstrap_v1" || capabilities[3] != "work_review_feedback_v1" {
